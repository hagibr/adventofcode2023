...
# In my puzzle input, there are 1540 components and 3451 connections.
# If we are going to test to remove every 3 connections to evaluate the disjunction in 2 groups, 
# then we will have to test C(3451,3) = 6843936925 combinations
