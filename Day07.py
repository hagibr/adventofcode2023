...
def sort_score_hand(hand):
  ...
  # The score starts by type
  score = game_type(hand[:])

  # Then we add the card strength in consideration, using the original positions
  for c in hand:
    score = score * 14 + card_strength[c]

  return score

# Starting the score_bid list with a 0 to make the score counting easier
score_bid = [[0,0]]
for line in input.splitlines():
  hand, bid = line.split()
  score = sort_score_hand(hand)
  bid = int(bid)
